...
class PointNet32(nn.Module):  # actually pointnet
    def __init__(self, point_channel=3, output_dim=32):
        # NOTE: we require the output dim to be 32, in order to match the pretrained weights
        super(PointNet32, self).__init__()
